...
function setBallTextures(){
	if(numBall == 0){
		ballTextures[0] = textureFromImage("resources/images/ball.jpg");
		numBall = 1;
	} else
	if(numBall == 1){
		ballTextures[0] = textureFromImage("resources/images/ball1.jpg");
		numBall = 2;
	} else
	if(numBall == 2){
		ballTextures[0] = textureFromImage("resources/images/ball2.jpg");
		numBall = 3;
	} else 	
	if(numBall == 3){
		ballTextures[0] = textureFromImage("resources/images/ball3.jpg");
		numBall = 4;
	} else 
	if(numBall == 4){
		ballTextures[0] = textureFromImage("resources/images/ball4.jpg");
		numBall = 5;
	} else
	if(numBall == 5){
		ballTextures[0] = textureFromImage("resources/images/ball5.jpg");
		numBall = 0;
	}	
}
function setTextures() {
	textures[0] = textureFromImage("resources/images/mappa.jpg");			//campo				
	textures[1] = textureFromImage("resources/images/cono.jpg");			//cono
	textures[2] = textureFromImage("resources/images/porta.jpg");			//porta	
	textures[3] = textureFromImage("resources/images/lowObstacle.jpg");		//lowobstacle	
	textures[4] = textureFromImage("resources/images/paletto.jpg"); 		//paletto
	textures[5] = textureFromImage("resources/images/world.jpg");			//san siro
	textures[6] = textureFromImage("resources/images/TTS.jpg");				//my texture
	textures[7] = textureFromImage("resources/images/barriera.jpg");		//barriera
	ballTextures[0] = textureFromImage("resources/images/ball.jpg"); 		//palla
}
...
function getBallToDraw(ballToDraw, name){

	return ballToDraw.find(x => x.name === name);
}
